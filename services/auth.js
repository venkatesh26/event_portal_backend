...
async function customer_authenticate(req, res, params){
	return models.users.findOne({
		where: {
			email: params.email,
			deletedAt: null,
		...
		if (user.is_email_verified==0)
			throw new CustomError('Your Email Verification Not Yet Completed !');
		
		if (user.is_active==0)
			throw new CustomError('Your Account was deactivated.Pls contact admin.');
